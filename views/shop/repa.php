...
$this->title = 'Крафтовые предметы';
?>

<div class="shop-container">
    <div class="shop-header">
        <h1>Крафтовые предметы</h1>
                        ...
                        <div class="purchase-block">
                            <div class="purchase-price">
                                ...
                                <div class="price-item repa <?= $user->repa >= $item->repa ? 'enough' : 'not-enough' ?>">
                                    Требуется репутация: <?= $item->repa ?>
                                </div>
                            </div>
                            
                            <div class="purchase-button">
                                <?php if($user->repa >= $item->repa && $user->kr >= $item->cost): ?>
                                    <a class="btn-buy btn-repa" 
                                       href="/shop/buyrepa?id=<?= $item->id ?>" 
    ...
    <?php else: ?>
        <div class="empty-message">
            <p>Крафтовых предметов пока нет</p>
        </div>
    <?php endif; ?>
</div>
